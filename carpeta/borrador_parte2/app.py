...
def index():
    return render_template("./manu/Templates/home.html") # aquí ponemos el html con la homepage

# Página insertar datos 
@app.route("/data_input/", methods=["GET"]) # ruta
def data_input():
    return render_template("./manu/Templates/prediction.html") # aquí ponemos el html con la pg donde insertamos los datos para predicción
...
def predict():
        ...
        return render_template("./manu/Templates/after.html", data=int(final_pred))
